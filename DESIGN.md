...
The one-page version required by the brief is [WRITEUP.md](WRITEUP.md). This is the
same ground covered at length, for anyone who wants the reasoning behind each
choice.
